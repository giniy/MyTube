...
CREATE TABLE `videos` (
  ...
  `content_warning` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 5, 'Drone View of Nature', 'Drone View of Nature', 'video_682657700eb019.24309285.mp4', 'thumb_682657700ef333.84963677.jpg', '2025-05-15 17:06:56', 0, 0, 0, 1, 1, NULL),
...
CREATE TABLE `video_ratings` (
  ...
  `user_id` int NOT NULL,
  `video_id` int NOT NULL,
  `rating` tinyint NOT NULL COMMENT '1 for like, -1 for dislike',
